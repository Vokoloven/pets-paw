    ...
    images.map(({ id, url, width, height, breeds }, index) => (
      ...
      >
        ...
        >
          ...
          />
          <div className="absolute bottom-[10px] left-[50%] -translate-x-2/4 py-[5px] px-[42px] leading-6 text-darkPink rounded-1.5lg bg-white transition-opacity opacity-0 group-hover:opacity-100 group-hover:transition-opacity text-center mobile:left-2.5 mobile:right-2.5 mobile:translate-x-0 laptop:px-[26px]">
